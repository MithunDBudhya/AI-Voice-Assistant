    ...
    <div className="flex-1 w-full h-full overflow-y-auto bg-slate-950 text-slate-50 flex flex-col relative">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto w-full">
        <div className="flex items-center space-x-3">
          ...
          <span className="font-bold text-2xl tracking-tight bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">
            SupportGenie
          </span>
        </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 text-center max-w-5xl mx-auto mt-12 mb-24">
        <motion.div 
          ...
          className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 text-sm font-medium mb-8"
        >
        ...
        >
          Talks. Understands. Retrieves. Acts. Escalates. Reports. <br/>
          Deploy a complete AI customer support operations platform in minutes.
        </motion.p>
        ...
        >
          <button 
            ...
            className="group flex items-center px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full font-semibold text-lg transition-all shadow-[0_0_40px_rgba(79,70,229,0.3)] hover:shadow-[0_0_60px_rgba(79,70,229,0.5)]"
          >
